...
const server = Bun.serve({
  ...
  routes: { "/": page, "/david": page, "/elisabeth": page, "/ine": page, "/eg/music": page, "/eg/sunbathing": page, "/eg/sleeping": page, "/eg/reading": page, "/eg/jumping": page, "/eg/drinking": page, "/eg/eating": page, "/api/game": handleGameRequest },
